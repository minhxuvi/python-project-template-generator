...
function generate-project {
    ...
    git add --all
    git branch -M main
    git commit -m "feat: generated sample project with python-project-template-generator"
}
...
EOF
    ...
    git commit -m 'feat!: populated from `python-project-template-generator` template'
    ...
    gh pr create \
        --title "feat: populated from \`python-project-template-generator\` template" \
        --body "This PR was generated by \`python-project-template-generator\`" \
        --base main \
